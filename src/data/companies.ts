...
export const companies: Company[] = [
  {
    name: 'Context Engine',
    oneLiner: 'Your company\'s permanent memory. A single-tenant, self-hostable context layer that captures emails, calls, documents, and decisions — and serves them to any MCP-capable tool or agent. Daimon, its ambient agent, lives in the chats where your team already works and surfaces the intelligence on demand.',
    url: 'https://contextengine.com',
    description: 'Your company\'s permanent memory. A single-tenant, self-hostable <a href="https://contextengine.com" target="_blank" rel="noopener">context layer for AI</a> that captures your emails, calls, documents, and decisions and serves them to any MCP-capable tool or agent, so your AI already knows your world without endless re-briefing. Daimon, its ambient agent, sits quietly inside the chats where your team already works, remembers what matters, and surfaces the intelligence on demand. Sold standalone at contextengine.com; part of the Relote stack.',
